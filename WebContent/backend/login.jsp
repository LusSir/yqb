   				...
   				<div class="col-md-6 col-md-offset-3">
   					<div class="panel panel-primary my_panel">
   						...
   						<div class="panel-body">
   							<form action="AdminServlet?action=loginAdmin"
										method="post" onsubmit="return checkValue()"
   							id="headForm" class="form-horizontal col-md-10 col-md-offset-1 my_login_f">
								...
								<div class="form-group">
									<div class="col-sm-offset-3 col-sm-3">
										<button type="submit" class="btn btn-primary" id="uploadbtn">登录</button>
									</div>
